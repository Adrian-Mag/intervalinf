"""Integration tests for PrimalKKTSolver with Lebesgue/SOLAOperator.
...
that PrimalKKTSolver.solve() completes without triggering it.
"""
...
from pygeoinf import PrimalKKTSolver
from pygeoinf import BallSupportFunction, KKTResult
    ...
    def test_no_model_to_components_during_solve(self):
        ...
        def _no_to(v):
            raise AssertionError(
                "PrimalKKTSolver.solve() called Lebesgue.to_components! "
                "This breaks basis-freedom."
            )

        def _no_from(coeffs):
            raise AssertionError(
                "PrimalKKTSolver.solve() called Lebesgue.from_components! "
                "This breaks basis-freedom."
            )
