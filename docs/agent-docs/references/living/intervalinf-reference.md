...
- `tests/test_full_spectrum_utils.py` (**Phases 1–4**, updated): 13 tests — block indexing (3), Phase 2 forward shapes (4), Phase 3 priors (3), Phase 4 posteriors (3).
...
- `example.ipynb` (**Phases 1–5**, updated): spectral inventory → data visualisation → forward operators → priors → posteriors → property operators + per-block property vector printout.
